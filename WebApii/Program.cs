...
IServiceCollection serviceCollection = builder.Services.AddDbContext<ContextBase>(options =>
...
builder.Services.AddSingleton<IntefaceDespesa, RepositorioDespesa>();
